;-----------------------------------------------------------------------;
;			SOUNDTRACKER V2.4 REPLAYER			;
;CONSISTS OF:								;
;ONE ST-REPLAY-ROUTINE							;
;    THIS PROGRAMM WAS FIXED ON 13/04/91 BY MR.BASE/FLASHING BYTES	;
;	          � 1991 BY FLASHING BYTES DEVELOPMENTS.		;
;		 THIS SOURCECODE IS ONLY FOR TFB-MEMBERS!		;
;-----------------------------------------------------------------------;
...
;-------------------------BEGINN DES PROGRAMMES--------------------------
                ...
                SECTION               banana,CODE_C

start:          MOVEM.L               D0-D7/A0-A6,-(A7)
                MOVE.B                #02,$BFE001
                move.l                $6c,oldirq+2                                       ;IRQ starten (Level 3)
                move.l                #newirq,$6c
                jsr                   mt_init
Wait:           btst                  #6,$bfe001
                bne.s                 Wait
                jsr                   mt_end
                move.l                oldirq+2,$6c                                       ;Alten IRQ restaurieren
                moveq                 #0,d0
                sub.l                 a0,a0	
                sub.l                 a1,a1
                MOVE.B                #00,$BFE001
